...
export default function CreateListing() {
    ...
    const storeImage = async (file)=>{
        return new Promise((resolve,reject)=>{
            ...
            const uploadTak = uploadBytesResumable(storageRef,file);
            uploadTak.on(
                "state_changed",
                (snapshot)=>{
        ...
        <form className=' flex flex-col sm:flex-row gap-10'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className="flex gap-4">
                    ...
                    <button disabled={uploading} type="button" onClick={handleImageSubmit}  className=' p-3 border border-green-700 text-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'> {uploading ? 'Uploading...' : 'Upload'} </button>
                </div>
